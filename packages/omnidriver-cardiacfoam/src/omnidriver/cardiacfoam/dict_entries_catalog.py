...
ELECTRO_PROPERTY_ENTRY_GROUPS: Final[dict[str, tuple[DictEntry, ...]]] = {
    ...
    "ionic_constant_overrides": build_group(
        ...
        DictEntry(
            ...
            value_kind='scalar',
            dynamic_path=True, allowed_bindings={"<scope>": ("global", "epicardialCells", "mCells", "endocardialCells", "myocyte"), "<constant_name>": None},
    ...
    "batched_integrator": build_group(
        ...
        DictEntry(
            ...
            description='Integration scheme for batched ionic models. Optional: defaults to euler when omitted.',
            source_refs=('src/ionicModels/ionicModel/batchedIonicModel.H',),
            notes='Read only via lookupOrDefault (batchedIonicModel.H:200) -- never required. Ionic models only: batched active-tension models always integrate with explicit Euler and do not read this key, so it places no constraint on activeTensionModel.',
            value_kind='enum',
    ...
    "bath_potential_domain": build_group(
        ...
        DictEntry(
            ...
            value_kind='scalar',
            dynamic_path=True, allowed_bindings={"<patch>": None},
            constraints=(
    ...
    "ecg": build_group(
        ...
        # This opt-in block has no defaults: an eikonal ECG case normally uses
        # compiled templates, and populating a nested default would silently
        # change that scientific choice.  The cardiac semantic validator
        # validates a configured block as a unit before execution.
        DictEntry(
            driver_path='$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.personalizedTemplates.ionicModelConfig.ionicModel',
            phases=frozenset({'physics'}),
            description='Ionic model used to generate eikonalECG personalized action-potential templates.',
        ...
        DictEntry(
            ...
            phases=frozenset({'physics'}),
            description='Tissue selector passed to the personalized-template ionic model.',
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalTemplateGenerator.C',),
            value_kind='enum',
            enum_values=('epicardialCells', 'mCells', 'endocardialCells', 'myocyte'),
            dynamic_path=True, allowed_bindings={"<name>": None},
            applicable_when={"$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.ecgSolver": "eikonalECG"},
        ...
        DictEntry(
            ...
            phases=frozenset({'physics'}),
            description='ODE solver used while pacing personalized-template anchors.',
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalTemplateGenerator.C',),
            value_kind='enum',
            enum_values=('RKF45', 'Euler'),
            dynamic_path=True, allowed_bindings={"<name>": None},
        ...
        DictEntry(
            ...
            phases=frozenset({'physics'}), description='Absolute ODE tolerance for personalized-template anchor pacing.',
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalTemplateGenerator.C',), value_kind='scalar', dynamic_path=True, allowed_bindings={"<name>": None},
            applicable_when={"$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.ecgSolver": "eikonalECG"},
        ),
        DictEntry(
            driver_path='$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.personalizedTemplates.ionicModelConfig.relTol',
            phases=frozenset({'physics'}), description='Relative ODE tolerance for personalized-template anchor pacing.',
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalTemplateGenerator.C',), value_kind='scalar', dynamic_path=True, allowed_bindings={"<name>": None},
            applicable_when={"$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.ecgSolver": "eikonalECG"},
        ),
        DictEntry(
            driver_path='$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.personalizedTemplates.ionicModelConfig.batchedSubsteps',
            phases=frozenset({'physics'}), description='Fixed-step substeps for a batched ionic model used to generate templates.',
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalTemplateGenerator.C',), value_kind='integer', dynamic_path=True, allowed_bindings={"<name>": None},
            applicable_when={"$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.ecgSolver": "eikonalECG"},
        ),
        DictEntry(
            ...
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalTemplateGenerator.C',), value_kind='scalar', unit='ms', dynamic_path=True, allowed_bindings={"<name>": None},
            applicable_when={"$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.ecgSolver": "eikonalECG"},
        ),
        DictEntry(
        ...
        DictEntry(
            ...
            phases=frozenset({'physics'}), description='S1 pulse count; personalizedTemplates.nBeats overrides this value.',
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalTemplateGenerator.C',), value_kind='integer', dynamic_path=True, allowed_bindings={"<name>": None},
            applicable_when={"$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.ecgSolver": "eikonalECG"},
        ),
        DictEntry(
            driver_path='$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.personalizedTemplates.ionicModelConfig.singleCellStimulus.nstim2',
            phases=frozenset({'physics'}), description='Optional S2 pulse count; must be zero when supplied.',
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalECG.C',), value_kind='integer', dynamic_path=True, allowed_bindings={"<name>": None},
            constraints=('personalizedTemplates rejects non-zero nstim2.',),
            applicable_when={"$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.ecgSolver": "eikonalECG"},
        ),
        DictEntry(
            driver_path='$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.personalizedTemplates.nBeats',
            phases=frozenset({'physics'}), description='Number of paced S1 beats before capturing the final template response.',
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalECG.C',), value_kind='integer', dynamic_path=True, allowed_bindings={"<name>": None},
        ...
        DictEntry(
            ...
            phases=frozenset({'physics'}), description='Final-beat template capture duration [s].',
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalECG.C',), value_kind='scalar', unit='s', dynamic_path=True, allowed_bindings={"<name>": None},
        ...
        DictEntry(
            ...
            phases=frozenset({'physics'}), description='Template-generator integration and capture step [s].',
            source_refs=('src/electroModels/ecgModels/eikonalECG/eikonalECG.C',), value_kind='scalar', unit='s', dynamic_path=True, allowed_bindings={"<name>": None},
        ...
        DictEntry(
            ...
            phases=frozenset({'physics'}),
            description='Explicit choice of ECG verification model when no nested verificationModel block is present.',
        ...
        # The selected solver's ECG verifier constructors read this nested
        # block.  It is a supported source-compatible alias surface, not a
        # generic verifier schema: alpha/k remain model-specific elsewhere.
        DictEntry(
            driver_path='$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.verificationModel.type',
            phases=frozenset({'physics'}),
            description='Runtime-selected ECG verification model; this nested selector takes precedence over ecgVerificationModel.',
            source_refs=('src/electroModels/core/verificationModels/ecgVerificationModel.C',),
            value_kind='enum',
            enum_values=('manufacturedPseudoECGVerifier', 'manufacturedEikonalECGVerifier', 'manufacturedBathBidomainECGVerifier'),
            dynamic_path=True, allowed_bindings={"<name>": None},
            applicable_when={"$ecgDomains_present": True},
        ...
        DictEntry(
            ...
            phases=frozenset({'physics'}), description='Enable the selected manufactured ECG verifier.',
            source_refs=('src/verificationModels/ecgVerification/manufacturedPseudoECGVerifier.C', 'src/verificationModels/ecgVerification/manufacturedEikonalECGVerifier.C', 'src/verificationModels/ecgVerification/manufacturedBathBidomainECGVerifier.C'),
        ...
        DictEntry(
            ...
            phases=frozenset({'physics'}), description='Geometric dimension used by pseudo- or eikonal-ECG manufactured verification.',
            source_refs=('src/verificationModels/ecgVerification/manufacturedPseudoECGVerifier.C', 'src/verificationModels/ecgVerification/manufacturedEikonalECGVerifier.C'),
        ...
        DictEntry(
            ...
            source_refs=('src/verificationModels/ecgVerification/manufacturedPseudoECGVerifier.C', 'src/verificationModels/ecgVerification/manufacturedEikonalECGVerifier.C'),
            value_kind='integer', dynamic_path=True, allowed_bindings={"<name>": None},
            applicable_when={"$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.verificationModel.type": ('manufacturedPseudoECGVerifier', 'manufacturedEikonalECGVerifier')},
        ),
        DictEntry(
            driver_path='$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.verificationModel.checkQuadratureOrders',
            phases=frozenset({'physics'}), description='Quadrature orders compared with the reference manufactured ECG integral.',
            source_refs=('src/verificationModels/ecgVerification/manufacturedPseudoECGVerifier.C', 'src/verificationModels/ecgVerification/manufacturedEikonalECGVerifier.C'),
            value_kind='integer_list', dynamic_path=True, allowed_bindings={"<name>": None},
            applicable_when={"$ELECTRO_MODEL_COEFFS.ecgDomains.<name>.verificationModel.type": ('manufacturedPseudoECGVerifier', 'manufacturedEikonalECGVerifier')},
        ),
        ),
    ),
    ...
    "conduction_system": build_group(
        ...
        DictEntry(
            ...
            dynamic_path=True, allowed_bindings={"<name>": None},
            required=True,
            constraints=('Required whenever a conductionNetworkDomains instance is configured.',),
        ),
        DictEntry(
        ...
        DictEntry(
            ...
            phases=frozenset({'stimulus'}),
            description='Start time [s] of the optional rootStimulus block when startTimeList is absent. Without the block, no root stimulus is applied.',
            source_refs=('src/electroModels/electroDomains/conductionSystemDomain/conductionSystemDomain.C',),
            notes='The solver uses this scalar only as the single-firing fallback when rootStimulus.startTimeList is absent.',
            value_kind='scalar',
            unit='s',
            dynamic_path=True, allowed_bindings={"<name>": None},
        ),
        DictEntry(
            ...
            phases=frozenset({'stimulus'}),
            description='List of root-stimulus firing times [s]. When present, it takes precedence over the single startTime fallback.',
            source_refs=('src/electroModels/electroDomains/conductionSystemDomain/conductionSystemDomain.C',),
            notes='conductionSystemDomain::readRootStimulus reads startTimeList into rootStartTimes_; otherwise it creates a one-element list from startTime.',
            value_kind='scalar_list',
            unit='s',
            dynamic_path=True, allowed_bindings={"<name>": None},
        ),
    ...
    "active_tension": build_group(
        ...
        DictEntry(
            ...
            notes="LandNiederer and LandNiedererTWorld re-derive several dependent constants (AC_fPKA_TnI, AC_XSSS, AC_XWSS, AC_A, AC_PKAForceMultiplier, AC_k_uw, AC_k_ws, AC_k_wu, AC_k_su, AC_cds, AC_cdw, AC_ktm_block) immediately after applying overrides -- overriding one of these listed-but-derived constants directly is a silent no-op, the re-derivation formula overwrites it unconditionally right after. Same 'listed != overridable' caveat as the ionic constant catalog. NashPanfilov does not re-derive; check the specific model's constructor before assuming a name is safely overridable.",
            value_kind='scalar',
            dynamic_path=True, allowed_bindings={"<constant_name>": None},
            constraints=('Only applicable when activeTensionModel is configured.',),
            applicable_when={"myocardiumSolver": "singleCellSolver"},
        ),
        DictEntry(
            ...
            value_kind='scalar',
            dynamic_path=True, allowed_bindings={"<state_name>": None},
            constraints=('Only applicable when activeTensionModel is configured.',),
            applicable_when={"myocardiumSolver": "singleCellSolver"},
        ),
        DictEntry(
            ...
            source_refs=('src/activeTensionModels/LandNiederer/LandNiederer.C', 'src/activeTensionModels/LandNiedererTWorld/LandNiedererTWorld.C', 'src/activeTensionModels/LandNiedererTWorldBatched/LandNiedererTWorldBatched.C'),
            value_kind='scalar',
            unit='ms',
