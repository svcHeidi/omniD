...
from omnidriver.cardiac.tutorials.manufactured_eikonal_ecg import make_spec
...
def test_tet_apply_case_renders_geo_installs_overlay_and_grad_scheme(tmp_path):
    ...
    with mock.patch("omnidriver.cardiac.tutorials.manufactured_eikonal_ecg.subprocess") as mock_subprocess:
