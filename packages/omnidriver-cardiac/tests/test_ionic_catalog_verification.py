...
from omnidriver.cardiac.ionic_catalog_verification import (
...
from omnidriver.cardiac.ionic_model_catalog import IonicModelEntry
...
def test_verify_ionic_catalog_reports_skipped_not_verified_when_utility_absent(monkeypatch):
    import omnidriver.cardiac.ionic_catalog_verification as mod
