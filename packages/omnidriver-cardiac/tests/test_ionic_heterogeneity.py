...
def test_default_single_cell_tissue_map_uses_native_tissues_only():
    from omnidriver.cardiac.tutorials.defaults.single_cell import IONIC_MODEL_TISSUE_MAP
...
def test_default_restitution_tissue_map_uses_native_tissues_only():
    from omnidriver.cardiac.tutorials.defaults.restitution_curves import IONIC_MODEL_TISSUE_MAP
