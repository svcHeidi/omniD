...
_add(
    ...
    preconditions=["Explicitly select the reference-transfer method for the study.",
                   ...
                   "Prepare aligned arrays externally. No native reader is supplied."],
    failures={"invalid_input": "Frame construction rejects invalid shapes, nonfinite values, missing bands/chambers and degenerate axes.",
              "missing_capability": "Native-file extraction and electrode-file writing are pending.",
    ...
    example="from omnidriver.cardiaccore.operations.electrodes import compute_lv_frame, apply_reference_offsets\nframe = compute_lv_frame(points, chamber, longitudinal)\npositions = apply_reference_offsets(frame)",
)
